...
func (t *tester) generate(parent common.Hash) (common.Hash, *trienode.MergedNodeSet, *state.Set) {
	var (
		ctx     = newCtx()
	...
	return root, ctx.nodes, state.New(ctx.accountOrigin, ctx.storageOrigin, nil)
}
