...
func NewSimulatedBackendWithDatabase(database ethdb.Database, alloc core.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
	...
	// Initialize the blockchain in hash-based scheme. The main reason for this
	// decision is that all trie nodes generated by chain can be shared with the
	// chain maker.
	blockchain, _ := core.NewBlockChain(database, core.DefaultCacheConfigWithScheme(trie.HashScheme), genesis.Config, ethash.NewFaker(), vm.Config{}, nil, nil)
