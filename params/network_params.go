...
const (
	...
	// considered immutable for full node (i.e. soft finality). It is used by the downloader
	// as a hard limit against deep ancestors, by the blockchain against deep reorgs, by
