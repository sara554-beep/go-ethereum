...
func verifyState(ctx *cli.Context) error {
	...
	triedb := trie.NewDatabase(chaindb, utils.ResolveStateDiffDir(ctx, stack), &trie.Config{ReadOnly: true})
...
func dumpState(ctx *cli.Context) error {
	...
	triedb := trie.NewDatabase(db, utils.ResolveStateDiffDir(ctx, stack), &trie.Config{ReadOnly: true})
