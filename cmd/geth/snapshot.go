...
func verifyState(ctx *cli.Context) error {
	...
	snaptree, err := snapshot.New(chaindb, triedb.New(chaindb, &triedb.Config{ReadOnly: true}), 256, headBlock.Root(), false, false, false)
	if err != nil {
...
func traverseState(ctx *cli.Context) error {
	...
	triedb := triedb.New(chaindb, &triedb.Config{ReadOnly: true})
...
func dumpState(ctx *cli.Context) error {
	...
	snaptree, err := snapshot.New(db, triedb.New(db, &triedb.Config{ReadOnly: true}), 256, root, false, false, false)
	if err != nil {
		return err
	}
