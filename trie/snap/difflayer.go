...
type diffLayer struct {
	...
	nodes  map[common.Hash]map[string]*types.NodeWithPrev // Cached trie nodes indexed by owner and path
...
func newDiffLayer(parent snapshot, root common.Hash, id uint64, nodes map[common.Hash]map[string]*types.NodeWithPrev) *diffLayer {
	dl := &diffLayer{
		root:   root,
		id:     id,
		nodes:  nodes,
...
func (dl *diffLayer) Update(blockRoot common.Hash, id uint64, nodes map[common.Hash]map[string]*types.NodeWithPrev) *diffLayer {
