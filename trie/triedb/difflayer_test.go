...
func TestMergeBasics(t *testing.T) {
	...
	parent := newDiffLayer(emptyLayer(), common.Hash{}, copyNodes(nodes))
	child := newDiffLayer(parent, common.Hash{}, copyNodes(nodes))
	child = newDiffLayer(child, common.Hash{}, copyNodes(nodes))
