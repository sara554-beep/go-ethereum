...
func TestNodeStoreCopyHashBased(t *testing.T) { testNodeStoreCopy(t, HashScheme) }
func TestNodeStoreCopyPathBased(t *testing.T) { testNodeStoreCopy(t, PathScheme) }

func testNodeStoreCopy(t *testing.T, scheme string) {
	env := fillDB(t, scheme)
	...
	store.write(EncodeStorageKey(common.Hash{}, path.Bytes()), node)
