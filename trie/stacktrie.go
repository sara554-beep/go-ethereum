...
func (o *StackTrieOptions) WithSkipBoundary(skipLeft, skipRight bool, owner common.Hash, checkNode func(path []byte) (bool, common.Hash), gauge metrics.Gauge) *StackTrieOptions {
