...
const (
	accountTrieNodekeyLength = 2*common.HashLength + 1 // SIMPLE-COMPACT format 32byte path + 32byte hash + length flag
	storageTrieNodeKeyLength = 3*common.HashLength + 1 // 32byte owner hash + SIMPLE-COMPACT format 32byte path + 32byte hash + length flag
)
