...
func testFork(t *testing.T, LightChain *LightChain, i, n int, comparator func(td1, td2 *big.Int)) {
	...
	if _, err := LightChain2.InsertHeaderChain(headerChainB, 1, false); err != nil {
...
func testReorg(t *testing.T, first, second []int, td int64) {
	...
	bc.InsertHeaderChain(makeHeaderChainWithDiff(bc.genesisBlock, first, 11), 1, false)
	bc.InsertHeaderChain(makeHeaderChainWithDiff(bc.genesisBlock, second, 22), 1, false)
...
func TestBadHeaderHashes(t *testing.T) {
	...
	if _, err = bc.InsertHeaderChain(headers, 1, false); err != core.ErrBlacklistedHash {
...
func TestReorgBadHeaderHashes(t *testing.T) {
	...
	if _, err := bc.InsertHeaderChain(headers, 1, false); err != nil {
