...
func testForkIDSplit(t *testing.T, protocol uint) {
	...
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, gspecNoFork, nil, configNoFork, engine, vm.Config{}, nil, nil)
		chainProFork, _ = core.NewBlockChain(dbProFork, gspecProFork, nil, configProFork, engine, vm.Config{}, nil, nil)
