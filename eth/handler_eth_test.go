...
func testForkIDSplit(t *testing.T, protocol uint) {
	...
	var (
		...
		blocksNoFork, _  = core.GenerateChain(configNoFork, gspecNoFork.ToBlock(), engine, rawdb.NewMemoryDatabase(), 2, nil)
		blocksProFork, _ = core.GenerateChain(configProFork, gspecProFork.ToBlock(), engine, rawdb.NewMemoryDatabase(), 2, nil)
