...
func (b *EthAPIBackend) StateAtBlock(ctx context.Context, block *types.Block, statedb *state.StateDB, checklive bool) (*state.StateDB, func(), error) {
	return b.eth.StateAtBlock(block, statedb, checklive)
}
