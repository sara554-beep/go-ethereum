...
func newTestBackend(t *testing.T, n int, gspec *core.Genesis, generator func(i int, b *core.BlockGen)) *testBackend {
	...
	chain, err := core.NewBlockChain(backend.chaindb, gspec, cacheConfig, backend.chainConfig, backend.engine, vm.Config{}, nil, nil)
	if err != nil {
...
func (b *testBackend) StateAtBlock(ctx context.Context, block *types.Block, parent *state.StateDB, checkLive bool) (*state.StateDB, func(), error) {
...
func (b *testBackend) StateAtTransaction(ctx context.Context, block *types.Block, txIndex int) (core.Message, vm.BlockContext, *state.StateDB, func(), error) {
