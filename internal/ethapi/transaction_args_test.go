...
func (b *backendMock) StateAndHeaderByNumberOrHash(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash, overrides *state.Overrides) (*state.StateDB, *types.Header, error) {
	return nil, nil, nil
}
