...
func makechain() (bc *core.BlockChain, addrHashes, txHashes []common.Hash) {
	...
	blocks, _ := core.GenerateChain(gspec.Config, genesis, ethash.NewFaker(), state.NewDatabase(db), testChainLen,
...
func makeTries() (chtTrie *trie.Trie, bloomTrie *trie.Trie, chtKeys, bloomKeys [][]byte) {
	chtTrie, _ = trie.New(common.Hash{}, common.Hash{}, common.Hash{}, rawdb.NewMemoryDatabase())
	bloomTrie, _ = trie.New(common.Hash{}, common.Hash{}, common.Hash{}, rawdb.NewMemoryDatabase())
