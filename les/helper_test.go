...
func testIndexers(db ethdb.Database, odr light.OdrBackend, indexerConfig *light.IndexerConfig) (*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer) {
	chtIndexer := light.NewChtIndexer(db, odr, indexerConfig.ChtSize, indexerConfig.ChtConfirms)
	bloomIndexer := eth.NewBloomIndexer(db, indexerConfig.BloomSize, indexerConfig.BloomConfirms)
	bloomTrieIndexer := light.NewBloomTrieIndexer(db, odr, indexerConfig.BloomSize, indexerConfig.BloomConfirms,
		indexerConfig.BloomTrieSize, indexerConfig.BloomTrieConfirms)
