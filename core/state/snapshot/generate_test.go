...
func newHelper() *testHelper {
	...
	triedb := trie.NewDatabase(diskdb, os.TempDir(), nil)
...
func (t *testHelper) CommitAndGenerate(runGen bool) (*trie.CommitResult, *diskLayer) {
	...
	t.triedb.Update(result.Root, common.Hash{}, result.Nodes())
...
func TestGenerateCorruptAccountTrie(t *testing.T) {
	...
	helper.triedb.Update(common.Hash{}, result.Root, result.Nodes())
