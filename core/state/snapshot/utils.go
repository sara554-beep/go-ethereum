...
func CheckDanglingStorage(chaindb ethdb.Database) error {
...
// snapshot difflayers.
func checkDanglingMemStorage(db ethdb.Database) error {
	start := time.Now()
...
func CheckJournalAccount(db ethdb.Database, hash common.Hash) error {
