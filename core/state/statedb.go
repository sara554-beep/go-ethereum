...
func (s *StateDB) Commit(deleteEmptyObjects bool) (common.Hash, error) {
	...
	if metrics.EnabledExpensive {
		...
		if set != nil {
			trieAccountUpdatedMeter.Mark(int64(set.Len()))
		}
	...
	// Merge the dirty nodes of account trie into global dirty set
	if set != nil {
		if err := nodes.Merge(set); err != nil { // set must be non-nil
			return common.Hash{}, err
		}
	}
