...
var (
	...
	TrieNodeAccountPrefix = []byte("A") // TrieNodeAccountPrefix + hexaryPath -> trie node
	TrieNodeStoragePrefix = []byte("O") // TrieNodeStoragePrefix + accountHash + hexaryPath -> trie node
...
// storageTrieNodeKey = TrieNodeStoragePrefix + nodePath
