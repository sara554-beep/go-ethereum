...
var (
	...
	MerkleStateFreezerName = "state"        // the folder name of merkle tree state history
	VerkleStateFreezerName = "state_verkle" // the folder name of verkle tree state history
)
