...
func (n *Node) OpenDatabase(name string, cache, handles int, namespace string, readonly bool) (ethdb.Database, error) {
	...
	if n.config.DataDir == "" {
		...
		db, err = rawdb.NewPebbleOrLevelDBDatabase(n.config.BackingDB, n.ResolvePath(name), cache, handles, namespace, readonly)
	}
...
func (n *Node) OpenDatabaseWithFreezer(name string, cache, handles int, ancient string, namespace string, readonly bool) (ethdb.Database, error) {
	...
	if n.config.DataDir == "" {
		...
		db, err = rawdb.NewPebbleOrLevelDBDatabaseWithFreezer(n.config.BackingDB, n.ResolvePath(name), cache, handles, n.ResolveAncient(name, ancient), namespace, readonly)
	}
