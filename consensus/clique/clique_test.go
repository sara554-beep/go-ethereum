...
func TestReimportMirroredState(t *testing.T) {
	...
	var (
		...
		engine = New(params.AllCliqueProtocolChanges.Clique, gendb)
	...
	chain, _ := core.NewBlockChain(gendb, nil, genspec, nil, engine, vm.Config{}, nil, nil)
	defer chain.Stop()

	blocks, _ := core.GenerateChain(params.AllCliqueProtocolChanges, genspec.ToBlock(), engine, gendb, 3, func(i int, block *core.BlockGen) {
